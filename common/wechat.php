...
class WxConfig{
	private $appId='wx7359b0e8154b7e2c';//公众号id
	private $appSecret='04624e8d18de32a68402ed76c0f758b1';//公众号密匙
	private $msgToken='weixin';
	private $EncodingAESKey='icGDz3zeCUMdhZNUt2nyh0VRZWNIyy6D2MyXul7TJ3n';//支付密匙
	private $mchid='1307242701';//商户号
	private $notify_url='http://ps.bzy2015.com/order/order/WxPayNotify';//用户在成功完成支付后，微信后台通知（POST）商户服务器（notify_url）支付结果
	private $mchkey='PAnzer31415926ffKDQzddk232kzldeD';//客户登录商户平台所设置的API密钥
	private $certPEM='certPEM';
	private $keyPEM='keyPEM';
